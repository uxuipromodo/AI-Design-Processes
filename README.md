...
1. Відкрий папку репозиторію в Claude Code
2. Скопіюй посилання на потрібний Figma файл
3. Напиши запит — приклади для кожного скіла нижче
4. Claude покаже план змін і запитає підтвердження
5. Після твого "так" — внесе зміни у Figma

> Claude завжди питає підтвердження перед будь-якими змінами у файлі. Нічого не зміниться без твого дозволу.
